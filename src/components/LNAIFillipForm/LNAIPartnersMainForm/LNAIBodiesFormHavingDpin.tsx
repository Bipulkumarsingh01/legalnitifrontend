    ...
    <div>
      ...
      <div>
        <FormLabel component={"legend"}>
          ...
          Number(LLPIN) or Foreign Limited Liability Partnership Identification
          number(FLLPIN) or any other registration number of body corporate{" "}
          {personNumber}
        </FormLabel>
        <TextField
          ...
          onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
            ...
            updatedPartnerNotHavingDpin.corporateIDNumber = +event.target.value;
      ...
      <div>
        ...
        <TextField
          ...
          onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
            ...
            updatedPartnerNotHavingDpin.nameBodyCorporate = event.target.value;
            setBodiesHavingDpinState(updatedPartnerNotHavingDpin);
          }}
        />
      </div>
      ...
      <div>
        ...
        />
        <FormControl>
          <InputLabel id="bodies-not-having-dpin-area-select">Area</InputLabel>
          <Select
            disabled={bodiesHavingDpinStateArea?.length > 0 ? false : true}
          ...
          >
            {bodiesHavingDpinStateArea?.map((fetchedAreas: any, index: any) => (
      ...
      <div>
        ...
        <div>
          ...
          <TextField
            ...
            value={
              bodiesHavingDpinState.surname ? bodiesHavingDpinState.surname : ""
            }
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
              let updatedPartnerNotHavingDpin = {
                ...bodiesHavingDpinState,
          ...
          <TextField
            ...
            placeholder="Email"
            value={
              bodiesHavingDpinState.emailID ? bodiesHavingDpinState.emailID : ""
            }
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
              let updatedPartnerNotHavingDpin = {
                ...bodiesHavingDpinState,
          ...
          <TextField
            ...
            placeholder="Company"
            value={
              bodiesHavingDpinState.company ? bodiesHavingDpinState.company : ""
            }
            onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
              let updatedPartnerNotHavingDpin = {
                ...bodiesHavingDpinState,
      ...
      <div>
        ...
        <TextField
          ...
          placeholder="Number of shares held"
          value={
            bodiesHavingDpinState.monetaryValueOfContributionInFigures !== -1
      ...
      <div>
        <FormLabel component={"legend"}>
          DIN/DPIN of person signing on behalf of the body corporate as nominee
        </FormLabel>
        <TextField
          id="outlined-controlled"
          placeholder=""
