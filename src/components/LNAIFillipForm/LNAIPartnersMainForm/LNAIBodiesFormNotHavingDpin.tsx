    ...
    <div>
      ...
      <div>
        ...
        <FormControl>
          ...
          <Select
            disabled={bodiesNotHavingDpinStateArea?.length > 0 ? false : true}
      ...
      <div>
        ...
        <TextField
          ...
          value={
            bodiesNotHavingDpinState.monetaryValueOfContributionInFigures !== -1
      ...
      <div>
        ...
        <TextField
          ...
          onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
            ...
            updatedPartnerHavingDpin.placeOfBirthDistrict = event.target.value;
            setBodiesNotHavingDpinState(updatedPartnerHavingDpin);
          }}
        />
        <TextField
      ...
      <div>
        <FormLabel component={"legend"}>
          Occupation Type of Person acting as nominee of the 1st body corporate
        </FormLabel>
        <Select
        ...
        >
          ...
          <MenuItem value="Governament Employee">Governament Employee</MenuItem>
