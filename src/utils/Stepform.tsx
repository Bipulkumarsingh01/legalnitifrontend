...
const StepForm = () => {
  ...
  const splabled = [{ label: "Funded" }, { label: "Bootstraped" }];
        ...
        <Grid item xs={12}>
            ...
            <>
              ...
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField
                    {...params}
                    label="Is the startup funded/bootstrapped"
                  />
                )}
              />
          ...
          {activeStep === 1 && (
            <>
              ...
              <TextField
                id="outlined-basic"
                label="Website or mobile app link, if any"
                variant="outlined"
              />
              <TextField
                id="outlined-basic"
          ...
          {activeStep === 2 && (
            <>
              ...
              <Autocomplete
                ...
                sx={{ width: 300 }}
                renderInput={(params) => (
                  <TextField {...params} label="You are intrested in" />
                )}
              />

              <TextField
                id="outlined-basic"
                label="Current number of employees (including founder)"
                variant="outlined"
              />
            </>
          )}
          ...
          {activeStep === 4 && (
            <>
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Is the startup creating an innovative product / service /
                  process or improving an existing product / service / process
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
          ...
          {activeStep === 5 && (
            <>
              ...
              <Typography variant="h6">
                ...
                for innovation, improvement and scalability.
              </Typography>
              <Box
                sx={{
                  width: 500,
              ...
              >
                <TextField
                  fullWidth
                  label="Please submit a brief note supporting the options chosen above for innovation, improvement and scalability."
                />
              </Box>
            </>
          )}
          {activeStep === 6 && (
            <>
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Is the startup creating a scalable business model with high
              ...
              >
                <TextField
                  fullWidth
                  label="Please mention any awards/recognition received by the entity"
                />
              </Box>
            </>
          )}
          ...
          {activeStep === 8 && (
            <>
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Do you have an videos, Pitchdeck, patent, tradematk, copyright
                  or any other supporting docs
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
          ...
          {activeStep === 9 && (
            <>
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Is the entity the result of merger or amalgamation?{" "}
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
                ...
                >
                  <FormControlLabel
                    value="Yes"
                    onClick={() => setUpld(true)}
                    control={<Radio />}
                    label="Yes"
                  />
                  <FormControlLabel
                    value="No"
                    onClick={() => setUpld(false)}
                    control={<Radio />}
                    label="No"
                  />
                </RadioGroup>
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  Is the entity formed as a result of conversion?{" "}
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
              ...
              <FormControl>
                <FormLabel id="demo-row-radio-buttons-group-label">
                  has the entity change its name??{" "}
                </FormLabel>
                <RadioGroup
                  row
                  aria-labelledby="demo-row-radio-buttons-group-label"
